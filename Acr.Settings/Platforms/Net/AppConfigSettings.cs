...
namespace Acr.Settings
{
    ...
    public class AppConfigSettings : AbstractSettings
    {
        ...
        public AppConfigSettings() : this(null, ConfigurationUserLevel.None) {}
        public AppConfigSettings(string fileName) : this(fileName, ConfigurationUserLevel.None) {}
        public AppConfigSettings(string fileName, ConfigurationUserLevel configLevel)
        {
        ...
        public override bool Contains(string key) => this.config.AppSettings.Settings[key] != null;
        ...
        protected override IDictionary<string, string> NativeValues() => this.config
                .AppSettings
                .Settings
                .AllKeys
                .ToDictionary(
